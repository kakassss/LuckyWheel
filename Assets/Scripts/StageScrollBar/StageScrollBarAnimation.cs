...
public class StageScrollBarAnimation : MonoBehaviour
{
    ...
    private void Movement()
    {
        ...
        sequence.Join(_scrollBarTexts.DOAnchorPos(new Vector2(_scrollBarTexts.anchoredPosition.x + POSX_MOVEMENT,_scrollBarTexts.anchoredPosition.y), .25f));
        sequence.Join(_scrollBarImages.DOAnchorPos(new Vector2(_scrollBarImages.anchoredPosition.x + POSX_MOVEMENT,_scrollBarImages.anchoredPosition.y), .25f));
    }
}
